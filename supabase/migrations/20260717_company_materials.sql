...
-- 2026-07-30: company_materials table creation intentionally omitted — feature removed in
-- 02d6463 ("remove materials tab"). product_approvals columns remain in use.
...
-- Intentionally not applied: materials feature removed from the app (02d6463).
