...
module.exports = {
  ...
  // observability
  createObservability: require('./observability.js').createObservability,
  getObservability: require('./observability.js').getObservability,

  // railway / trigger deployment helpers
  railwayRecovery: require('./railway-recovery.js'),
  triggerClient: require('./trigger-client.js'),
