...
const COUNTY_OPTIONS = [
  ...
  { id: 'hillsborough', label: 'Hillsborough County', provider: 'hillsborough_accela' },
  { id: 'pinellas', label: 'Pinellas County', provider: 'pinellas_accela' },
  { id: 'pasco', label: 'Pasco County', provider: 'pasco_accela' },
  { id: 'charlotte', label: 'Charlotte County', provider: 'charlotte_accela' },
  { id: 'lake', label: 'Lake County', provider: 'lake_oprs' },
  { id: 'manatee', label: 'Manatee County', provider: 'manatee_accela' },
  { id: 'brevard', label: 'Brevard County', provider: 'brevard_accela' },
  { id: 'osceola', label: 'Osceola County', provider: 'osceola_accela' },
  { id: 'citrus', label: 'Citrus County', provider: 'citrus_accela' },
...
function providerForPortal(portal) {
  ...
  if (key.includes('hillsborough')) return 'hillsborough_accela'
  if (key.includes('pinellas')) return 'pinellas_accela'
  if (key.includes('pasco')) return 'pasco_accela'
  if (key.includes('charlotte')) return 'charlotte_accela'
  if (key.includes('lake')) return 'lake_oprs'
  if (key.includes('manatee')) return 'manatee_accela'
  if (key.includes('brevard')) return 'brevard_accela'
  if (key.includes('osceola')) return 'osceola_accela'
  if (key.includes('citrus')) return 'citrus_accela'
