export const permitStatusConfig = {
  ...
  // Shifted one step from mapped blue-100/700 — avoids collision with ready (#dbeafe/#1d4ed8)
  waiting_for_noc:    { bg: '#bfdbfe', text: '#1e40af', label: 'Waiting for NOC' },
  // ZIG-8: minimal label so unknown-status fallback does not render as Draft
...
export const nocStatusConfig = {
  ...
  // Shifted one step from mapped blue-100/700/500 — avoids collision with ready/sent (#dbeafe/#1d4ed8)
  queued_for_erecord:       { bg: '#bfdbfe', text: '#1e40af', label: 'Queued for eRecord', dot: '#1d4ed8' },
  ready_for_erecord_review: { bg: '#fef3c7', text: '#b45309', label: 'Ready for eRecord review', dot: '#f59e0b' },
  submitted_to_erecord:     { bg: '#bfdbfe', text: '#1e40af', label: 'Recording in progress', dot: '#1d4ed8' },
  recorded:                 { bg: '#bbf7d0', text: '#14532d', label: 'Recorded', dot: '#16a34a' },
  ready_for_download:         { bg: '#bfdbfe', text: '#1e40af', label: 'Ready for download', dot: '#1d4ed8' },
...
export const jobTimelineStages = [
  ...
  { key: 'noc_generated', label: 'NOC generated', match: job => ['generated', 'ready_for_download', 'queued_for_notarization', 'sent_to_homeowner', 'sent_for_notarization', 'signed', 'notarized', 'submitted_to_erecord', 'recorded'].includes(job.noc_status) || Boolean(job.noc_file_path) },
